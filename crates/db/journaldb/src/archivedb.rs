...
//     }
//
//     fn inject(&mut self, batch: &mut DBTransaction) ->Result<u32,&str> {
//         let mut inserts = 0usize;
//         let mut deletes = 0usize;
//
//         for i in self.overlay.drain() {
...
//                     return Err(&error_key_already_exists(&key).to_string());
//                 }
//                 batch.put(self.column, key.as_bytes(), &value);
//                 inserts += 1;
//             }
...
//                     return Err(&error_negatively_reference_hash(&key).to_string());
//                 }
...
//         // history is 1
//         let mut jdb = ArchiveDB::new(Arc::new(ethcore_db::InMemory::create(0)), None);
//
...
//     #[test]
//     fn reopen() {
//         let shared_db = Arc::new(ethcore_db::InMemory::create(0));
//         let bar = H256::random();
//
//         let foo = {
...
//     #[test]
//     fn returns_state() {
//         let shared_db = Arc::new(InMemory::create(0));
//
//         let key = {
//             let mut jdb = ArchiveDB::new(shared_db.clone(), None);
