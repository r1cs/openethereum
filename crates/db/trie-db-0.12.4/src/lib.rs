...
pub use self::recorder::{Record, Recorder};
pub use self::sectriedb::SecTrieDB;
pub use self::sectriedbmut::SecTrieDBMut;
pub use self::triedb::{TrieDB, TrieDBIterator};
pub use self::triedbmut::{ChildReference, TrieDBMut};
    ...
    C: NodeCodec<H> + 'db,
{
    ...
    pub fn readonly(
        &self, db: &'db dyn HashDBRef<H, DBValue>, root: &'db H::Out,
    ...
    pub fn create(
        &self, db: &'db mut dyn HashDB<H, DBValue>, root: &'db mut H::Out,
