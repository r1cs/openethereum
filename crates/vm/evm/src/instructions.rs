...
static INSTRUCTIONS: [Option<InstructionInfo>; 0x100] = {
    ...
    arr[RETURNDATASIZE as usize] = Some(InstructionInfo::new(
        "RETURNDATASIZE",
        0,
        1,
        GasPriceTier::Base,
    ));
    arr[RETURNDATACOPY as usize] = Some(InstructionInfo::new(
        "RETURNDATACOPY",
        3,
        0,
        GasPriceTier::VeryLow,
    ));
    ...
    arr[CALLDATALOAD as usize] = Some(InstructionInfo::new(
        "CALLDATALOAD",
        1,
        1,
        GasPriceTier::VeryLow,
    ));
    arr[CALLDATASIZE as usize] = Some(InstructionInfo::new(
        "CALLDATASIZE",
        0,
        1,
        GasPriceTier::Base,
    ));
    arr[CALLDATACOPY as usize] = Some(InstructionInfo::new(
        "CALLDATACOPY",
        3,
        0,
        GasPriceTier::VeryLow,
    ));
    arr[EXTCODEHASH as usize] = Some(InstructionInfo::new(
        "EXTCODEHASH",
        1,
        1,
        GasPriceTier::Special,
    ));
    arr[CODESIZE as usize] = Some(InstructionInfo::new("CODESIZE", 0, 1, GasPriceTier::Base));
    arr[CODECOPY as usize] = Some(InstructionInfo::new(
        "CODECOPY",
        3,
        0,
        GasPriceTier::VeryLow,
    ...
    arr[EXTCODESIZE as usize] = Some(InstructionInfo::new(
        "EXTCODESIZE",
        1,
        1,
        GasPriceTier::Special,
    ));
    arr[EXTCODECOPY as usize] = Some(InstructionInfo::new(
        "EXTCODECOPY",
        4,
        0,
        GasPriceTier::Special,
    ...
    arr[JUMPDEST as usize] = Some(InstructionInfo::new(
        "JUMPDEST",
        0,
        0,
        GasPriceTier::Special,
    ...
    arr[SWAP10 as usize] = Some(InstructionInfo::new(
        "SWAP10",
        11,
        11,
        GasPriceTier::VeryLow,
    ));
    arr[SWAP11 as usize] = Some(InstructionInfo::new(
        "SWAP11",
        12,
        12,
        GasPriceTier::VeryLow,
    ));
    arr[SWAP12 as usize] = Some(InstructionInfo::new(
        "SWAP12",
        13,
        13,
        GasPriceTier::VeryLow,
    ));
    arr[SWAP13 as usize] = Some(InstructionInfo::new(
        "SWAP13",
        14,
        14,
        GasPriceTier::VeryLow,
    ));
    arr[SWAP14 as usize] = Some(InstructionInfo::new(
        "SWAP14",
        15,
        15,
        GasPriceTier::VeryLow,
    ));
    arr[SWAP15 as usize] = Some(InstructionInfo::new(
        "SWAP15",
        16,
        16,
        GasPriceTier::VeryLow,
    ));
    arr[SWAP16 as usize] = Some(InstructionInfo::new(
        "SWAP16",
        17,
        17,
        GasPriceTier::VeryLow,
    ...
    arr[CALLCODE as usize] = Some(InstructionInfo::new(
        "CALLCODE",
        7,
        1,
        GasPriceTier::Special,
    ...
    arr[DELEGATECALL as usize] = Some(InstructionInfo::new(
        "DELEGATECALL",
        6,
        1,
        GasPriceTier::Special,
    ));
    arr[STATICCALL as usize] = Some(InstructionInfo::new(
        "STATICCALL",
        6,
        1,
        GasPriceTier::Special,
